<header id="mu-hero">
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light mu-navbar">
			   	...
			   	<a class="navbar-brand mu-logo" href="{{ route('home') }}"><img id="cc" src="home/images/logo5.jpg" alt="logo"></a> 
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    <ul class="navbar-nav mr-auto mu-navbar-nav">
			      ...
			      <li class="nav-item active">
			        <a style="color:white;" href="{{ route('home') }}"><center>Hotline<br>+60 11-5902 6509</center></a>
			      </li>
			    </ul>
			  </div>
			</nav>
